...
class TaskMDataProvider : NSObject, NSFetchedResultsControllerDelegate {
    ...
    init(managedObjectContext: NSManagedObjectContext) {
        ...
        request.sortDescriptors = [NSSortDescriptor(key: "statusChecked", ascending: true)]
        
        self.fetchedResultController = NSFetchedResultsController(fetchRequest: request, managedObjectContext: managedObjectContext, sectionNameKeyPath: nil, cacheName: nil)
